...
result = data.get_df(mode='ANN', sample=True, sample_size=100)
...
print(model)
model, test_loss, correct = classifier.trainmodel(model, train_df, val_df, test_df, epochs=10, lr=3e-4, batch_size=32, plot=True, class_name = data.class_name)
